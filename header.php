            ...
            <div class="container">
                ...
                <div class="header__content">
                    <div class="hero header__hero">
                        ...
                        <!-- <button data-fancybox data-src="#order-form" class="btn btn_large but-effect popmake-71">Записаться онлайн</button> -->
                        <button data-fancybox data-src="#form"  class="btn btn_large but-effect">Записаться онлайн</button>
                        ...
                        <div class="hero__social">
                            <ul class="social social_horizon">
                                ...
                                <li class="social__item"><a href="https://t.me/79521555936?text=Здравствуйте%2C+у+меня+есть+вопрос"><img class="social__link"  src="<?php echo get_template_directory_uri() ?>/assests/img/telegram.png" alt="telegram"></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <ul class="social social_vertical header__social">
                        ...
                        <li class="social__item"><a href="https://t.me/79521555936?text=Здравствуйте%2C+у+меня+есть+вопрос"><img class="social__link"  src="<?php echo get_template_directory_uri() ?>/assests/img/telegram_w.png" alt="telegram"></a></li>
                    </ul>
                </div>
                        <div class="hero__triangle"></div>
                        <div class="hero__columns">
